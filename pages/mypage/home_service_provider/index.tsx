...
interface MyPageSSRPropsType {
  data: IHSProvider.IPrivate;
}

const HomeServiceProvider = ({ data }: MyPageSSRPropsType) => {
      ...
      <S.MyPageContainer>
        <S.MyPageProfileContainer>
          <S.MyPageProfileTitleContainer>
            <S.MyPageProfileTitleContainerTitle>생활전문가</S.MyPageProfileTitleContainerTitle>
          ...
          <S.MyPageInfomationContainer>
            ...
            <S.MyPageInfomationBox>
              ...
              <S.MyPageInputBox>
                ...
                <S.MyPageInput placeholder="등록된 대표자 성명을 입력하세요" />
              </S.MyPageInputBox>
              <S.MyPageInputBox>
                <S.MyPageInputText>대표자 연락처</S.MyPageInputText>
                <S.MyPageInput placeholder="일반 전화번호를 입력하세요" />
              </S.MyPageInputBox>
              <S.MyPageInputBox>
            ...
            <S.MyPageInfomationBox>
              <S.MyPageInfomationHeader>개인 정보</S.MyPageInfomationHeader>
              <S.MyPageInputBox>
                <S.MyPageInputText>소속중개사(본인) 성명</S.MyPageInputText>
                <S.MyPageInput placeholder="실명을 입력하세요" />
              </S.MyPageInputBox>
              <S.MyPageInputBox>
                <S.MyPageInputText>본인 연락처</S.MyPageInputText>
                <S.MyPageInput placeholder="010-1234-5678" />
              </S.MyPageInputBox>
              <S.MyPageInputBox>
              ...
              <S.MyPageInputBox>
                <S.MyPageInputText>서비스 전문가 본인 사진</S.MyPageInputText>
                <S.MyPageLabelBox>
                  <S.MyPageLabel htmlFor="file1">
                    <div>
                      <svg width="50" height="50" viewBox="0 0 35 34" fill="none" xmlns="http://www.w3.org/2000/svg">
